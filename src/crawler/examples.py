...
"""
This script prints outputs examples from the flickr API
not meant for production, but for testing the API
"""
...
def test_get_public_photos(owner_nsid="134017397@N03"):
    ...
    print(photos['photo'][4])

def test_get_licenses():
    flickr = get_flickr_endpoint()
    print(flickr.photos.licenses.getInfo())
